...
#define WD_IOC_GET_COHERENT   _IOR (WD_IOC_MAGIC, 0, uint64_t)
#define WD_IOC_MAP_HUGEPAGE   _IOWR(WD_IOC_MAGIC, 1, uint64_t)
#define WD_IOC_PASSTHROUGH    _IOWR(WD_IOC_MAGIC, 2, uint64_t)
